...
class WC_Gateway_NicheClear_BasicCard extends WC_Gateway_NicheClear_Base {
	...
	public function __construct() {
		...
		parent::__construct();
		$this->id                 = 'nc_basic_card'; // Unique ID for the gateway.
		$this->icon               = ''; // URL of the icon that represents the gateway.
		$this->has_fields         = false; // If the gateway has custom form fields.
		$this->method_title       = 'Card';
		$this->method_description = 'Card payment processor';
